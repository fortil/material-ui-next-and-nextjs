...
class UpdateEntry extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      youtubeUrl: entry.youtube ? 'https://www.youtube.com/watch?v=' + entry.youtube : '',
    }
    
  }
  
  publish = () => {
    let values = ['description', 'title', 'ispublic', 'id', 'creationdate', 'active', 'youtube', 'important']
            ...
            <FormControl autoComplete="off" fullWidth className={classes.margin}>
              ...
              <label htmlFor="raised-button-file">
                <div style={{ display: 'flex', flexFlow: 'column wrap' }}>
                  <Button color="primary" variant="raised" component="span" className={classes.button} style={{ fontSize: 14 }}>
                    Adjuntar Imagen
