          ...
          <Grid item xs={12}>
            <Grid container spacing={24}>
              ...
              <Grid item md={8} style={{ color: 'white', textAlign: 'center' }} className={classes.mobileCss}>
                ...
                <p className={[lead, 'p'].join(' ')} style={{ fontSize: 15 }}>SURCOLOMBIANA DE GAS S.A. E.S.P. es una Empresa de Servicios Públicos Domiciliarios que nació en el año 2004, como una respuesta del Departamento del Huila para aquellos municipios que no cuentan con el servicio de Gas Domiciliario, buscando implementar un sistema que satisficiera las expectativas de sus habitantes e impulsar proyectos de inversión.. <Link href="/nosotros"><a style={{ textDecoration: 'none', color: 'white' }}>Ver más..</a></Link></p>
              </Grid>  
              <Grid item md={2}>
              </Grid>
            </Grid>
