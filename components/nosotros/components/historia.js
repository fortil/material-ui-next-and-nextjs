      ...
      <article className={[seccion, m0, p0].join(' ')}>
        <Grid container className={container}>
          <Grid item xs={12} className={[classes.justifyText, classes.styleText].join(' ')}>
            ...
            <p className='p'><b>SURCOLOMBIANA DE GAS S.A.E.S.P.</b> es una Empresa de Servicios Públicos Domiciliarios que nació en el año 2004, como una respuesta del Departamento del Huila para aquellos municipios que no cuentan con el servicio de Gas Domiciliario, buscando implementar un sistema que satisficiera las expectativas de sus habitantes e impulsar proyectos de inversión, estimulando de esta manera la creación de empresas como fuentes generadoras de empleo sostenible y promotoras del desarrollo regional.</p>
      
            <p className='p'>Se creó como una Empresa Mixta, organizada como sociedad anónima en los términos del Artículo 17 de la Ley 142 de 1994, de nacionalidad Colombiana y sujeta al régimen de la Ley de Servicios Públicos, constituida el 1º de Diciembre de 2004 mediante Escritura Pública 1943, de la Notaria Primera del Municipio de Pitalito y cuyo objeto social principal es la prestación del servicio público de gas combustible en el componente de distribución y comercialización y las actividades inherentes y conexas a dicho servicio.</p>

            <p className='p'>Su sede principal está ubicada en la ciudad de Pitalito en la carrera 1B No. 4 – 58, desde donde se coordinan las labores operativas y de mantenimiento y una oficina de apoyo administrativo y técnico en la ciudad de Neiva ubicada en la carrera 16 No. 46 – 24, desde donde se coordinan dieciocho(21) centros de atención y operación de los propano productos de los  municipios de:
